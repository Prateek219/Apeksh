                    ...
                    <div className="col-lg-3 col-md-6 col-sm-12">
                        <div className="box-footer-row4">
                                ...
                                <ul>
                                    ...
                                    <li><a href="https://twitter.com/ne_apekshm" target={'_blank'} rel="noreferrer"><FontAwesomeIcon icon={faTwitter} /></a></li>
                                    <li><a href="https://github.com/apekshElhadidy" target={'_blank'} rel="noreferrer"><FontAwesomeIcon icon={faGithub} /></a></li>
